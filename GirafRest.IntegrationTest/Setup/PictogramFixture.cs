        ...
        public PictogramFixture()
        {
            ...
            {{
                'data': [
                    ...
                    {{'id': 2, 'lastEdit': '{LAST_EDIT_TIMESTAMP}', 'title': 'gul', 'accessLevel': 1, 'imageHash': 'secure hash', 'imageUrl': '/v1/pictogram/2/image/raw'}},
                    {{'id': 5, 'lastEdit': '{LAST_EDIT_TIMESTAMP}', 'title': 'alle', 'accessLevel': 1,'imageHash': 'secure hash', 'imageUrl': '/v1/pictogram/5/image/raw'}},
                    {{'id': 8, 'lastEdit': '{LAST_EDIT_TIMESTAMP}', 'title': 'berøre', 'accessLevel': 1,'imageHash': 'secure hash', 'imageUrl': '/v1/pictogram/8/image/raw'}}
                ]
            }}";
