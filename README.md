...
An explination of the structure of the web-api can be found on the [wiki](https://aau-giraf.github.io/wiki/Development/Web_API/), and a setup guide can be found [here](https://aau-giraf.github.io/wiki/Setup/Index/).
