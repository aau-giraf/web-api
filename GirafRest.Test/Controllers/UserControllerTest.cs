...
//end remember
        ...
        public void UpdateUserSettings_movedToRight_checkResourceAppearenceOk()
        {
            ...
            var dto = new LauncherOptionsDTO();
            dto.CheckResourceAppearence = ResourceAppearence.movedToRight;
            usercontroller.UpdateUserSettings(dto).Wait();

            Assert.Equal(ResourceAppearence.movedToRight, _testContext.MockUsers[CitizenDepTwo].Settings.CheckResourceAppearence);
        }        
        [Fact]
