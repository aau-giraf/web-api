...
namespace GirafRest.Setup
{
    ...
    public class DBInitializer
    {
        ...
        public static void Initialize(GirafDbContext context, UserManager<GirafUser> userManager)
        {
            ...
            sampleData.pictogramList = AddSamplePictograms(context, sampleData.pictogramList);

            AddSampleWeekAndWeekdays(context, sampleData.pictogramList);
        ...
        #region base64
        private static List<Pictogram> AddSamplePictograms(GirafDbContext context, List<Pictogram> pictograms)
        {
