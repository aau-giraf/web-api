...
namespace GirafRest.Models
{
    ...
    public class Activity
    {
        ...
        public Activity(Weekday weekday, List<Pictogram> pictograms, int order, ActivityState state, Timer timer, bool choiceBoard, string title, string choiceBoardName )
        {
            this.Other = weekday;
            this.Order = order;
            this.State = state;
