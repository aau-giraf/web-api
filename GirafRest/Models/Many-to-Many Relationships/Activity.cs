...
namespace GirafRest.Models
{
    ...
    public class Activity
    {
        ...
        public Activity(Weekday weekday, List<Pictogram> pictograms, int order, ActivityState state, Timer timer, bool choiceBoard, string choiceBoardName = "ChoiceBoard")
        {
            this.Other = weekday;
            this.Order = order;
            this.State = state;
