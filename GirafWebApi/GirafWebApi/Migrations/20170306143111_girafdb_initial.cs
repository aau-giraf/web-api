...
{
    public partial class girafdb_initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Department_Key = table.Column<long>(nullable: true),
                    owner_id = table.Column<long>(nullable: true),
                    DepartmentKey = table.Column<long>(nullable: true),
                    ImageKey = table.Column<long>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConcurrencyStamp = table.Column<string>(nullable: true),
                    Department_Key = table.Column<long>(nullable: false),
                    Email = table.Column<string>(maxLength: 256, nullable: true),
                    EmailConfirmed = table.Column<bool>(nullable: false),
                    IconKey = table.Column<long>(nullable: true),
